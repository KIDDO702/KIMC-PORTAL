...
@section('body')
    <div class="bg-white drop-shadow-sm w-full rounded">
        <div class="flex items-center justify-between py-2 px-8">
            <div>
                <h3 class="font-bold uppercase text-blue-950 text-2xl">Course Level</h3>
            </div>
            <div>
                <ol class="flex items-center space-x-3">
                    ...
                    <li class="flex items-center justify-center">
                        <small class="text-gray-600 font-light">Course Level</small>
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="mt-10 bg-white drop-shadow-sm px-10 py-5 rounded">
        ...
        <div>
            <livewire:admin.course-level-table />
        </div>
    </div>
@endsection
