...
@section('body')
            ...
            <div>
                <ol class="flex items-center space-x-3">
                    <li class="flex items-center justify-center">
                        <a href="{{ route('admin.index') }}" class="text-blue-secondary font-light text-sm underline underline-offset-2 underline-blue-secondary">Dashboard</a>
                    </li>
                    <li class="flex items-center justify-center">
                    ...
                    <li class="flex items-center justify-center">
                        <small class="text-gray-600 font-light">Departments</small>
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="bg-white py-4 px-10 mt-10 drop-shadow-sm rounded w-full">
        <div class="flex justify-between items-center">
            ...
            <div>
                <a href="{{ route('department.create') }}" class="px-3 py-1.5 rounded flex items-center justify-center text-white bg-blue-secondary hover:bg-blue-primary">
